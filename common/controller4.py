...
class CameraController():
    ...
    def set_params(self, ptz_angle, uav_angle, uav_location, car_location, car_angle, zoom:int):
        # uav_location[0] *= -1
        # car_location[0] *= -1
        # uav_location[1] *= -1
        # car_location[1] *= -1
    ...
    def get_rot_cam2uav(self):
        ...
        pitch = np.deg2rad(-90) #self.cam_angle[1]# * pi / 180 # pitch radians
        ...
        # rot_matrix = R.from_quat([self.cam_angle.x, self.cam_angle.y, self.cam_angle.z, self.cam_angle.w]).as_matrix()
