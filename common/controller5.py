...
class CameraController():
    def __init__(self, cam_props) -> None:
    ...
    def set_params(self, ptz_angle, uav_angle, uav_location, car_location, car_angle, view_matrix, projection_matrix, zoom:int):
        # uav_location[0] *= -1
        # car_location[0] *= -1
        # uav_location[1] *= -1
        # car_location[1] *= -1
        ...
        self.view_matrix = np.asmatrix(view_matrix)
        self.projection_matrix = np.asmatrix(projection_matrix)
