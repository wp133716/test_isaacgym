...
np.set_printoptions(edgeitems=30, infstr='inf', linewidth=4000, nanstr='nan', precision=8, suppress=True, threshold=10, formatter=None)
...
def convertPixelToPhy(aRoi, aCameraMatrix):
    ...
    unitVector = rotCoord @ aVector / np.linalg.norm(aVector)
    return unitVector
...
def servoExtPixel(aServoExtPixelParam, xPixelMove, yPixelMove):
    ...
    print("unitYInit: ", unitYInit)
    print("unitZInit: ", unitZInit)
    print("rotInitPitchVector: \n", rotInitPitchVector)
    print("rotInitYawVector: \n", rotInitYawVector)
    print("unitMoveViewVector: \n", unitMoveViewVector)
    print("unitRotViewVector: ", unitRotViewVector)
    print("servoAngle: ", servoAngle)
...
if __name__ == "__main__":
    ...
    servoExtPixelParam.camAngle = np.array([-10, -90, 30])
